          ...
          <div class="p-3 py-5">
            ...
            <div class="row mt-3">
              ...
              <div class="col-md-12">
                ...
                <textarea class="form-control" name="txtDesc" id="txtDesc" rows="2" placeholder="<?php echo $_SESSION['desc']; ?>"></textarea>
              </div>
              ...
              <div class="col-md-12">
                ...
                <input type="email" class="form-control" name="txtNewEmail" value="<?php echo $_SESSION['username']; ?>" "placeholder="enter newEmail">
              </div>


              <div class="col-md-12">
                <label class="labels">Password</label>
                <input type="password" name="txtPassword" class="form-control" placeholder="New password" value="">
              </div>
